        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                using (MySqlConnection testConn = new MySqlConnection(connectionString))
                {
                    ...
                    Console.WriteLine("Подключено к MySQL");
            ...
            catch (MySqlException ex)
            {
                ...
                Console.WriteLine("\nПроверьте:");
                Console.WriteLine("Запущен ли MySQL (XAMPP)");
                Console.WriteLine("Существует ли база данных 'ftp_server'");
                Console.WriteLine("Правильность строки подключения");
                Console.ForegroundColor = ConsoleColor.White;
